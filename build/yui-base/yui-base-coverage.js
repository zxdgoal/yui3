...
_yuitest_coverage["build/yui-base/yui-base.js"].coveredLines = 841;
_yuitest_coverage["build/yui-base/yui-base.js"].coveredFunctions = 100;
...
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "_isNative", 1841);
...
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isArray", 1859);
...
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isBoolean", 1870);
...
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isDate", 1881);
_yuitest_coverline("build/yui-base/yui-base.js", 1882);
...
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isFunction", 1909);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1920);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNull", 1920);
...
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNumber", 1931);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isObject", 1946);
...
L.isString = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isString", 1959);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1970);
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isUndefined", 1970);
_yuitest_coverline("build/yui-base/yui-base.js", 1971);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1983);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isValue", 1983);
...
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 9)", 2007);
...
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "sub", 2022);
_yuitest_coverline("build/yui-base/yui-base.js", 2023);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 10)", 2023);
...
L.trim = L._isNative(STRING_PROTO.trim) && !WHITESPACE.trim() ? function(s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 11)", 2036);
_yuitest_coverline("build/yui-base/yui-base.js", 2037);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2038);
_yuitest_coverline("build/yui-base/yui-base.js", 2039);
try {
        _yuitest_coverline("build/yui-base/yui-base.js", 2040);
return s.replace(TRIMREGEX, '');
    } catch (e) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2042);
return s;
    }
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2053);
L.trimLeft = L._isNative(STRING_PROTO.trimLeft) && !WHITESPACE.trimLeft() ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 12)", 2053);
_yuitest_coverline("build/yui-base/yui-base.js", 2054);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2055);
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2066);
L.trimRight = L._isNative(STRING_PROTO.trimRight) && !WHITESPACE.trimRight() ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 13)", 2066);
_yuitest_coverline("build/yui-base/yui-base.js", 2067);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2068);
_yuitest_coverline("build/yui-base/yui-base.js", 2069);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "type", 2099);
...
_yuitest_coverline("build/yui-base/yui-base.js", 2107);
var Lang   = Y.Lang,
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "YArray", 2140);
...
startIndex || (startIndex = 0);
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2146);
...
YArray.dedupe = Lang._isNative(Object.create) ? function (array) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 14)", 2183);
...
return results;
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2198);
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 15)", 2230);
_yuitest_coverline("build/yui-base/yui-base.js", 2231);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui-base/yui-base.js", 2232);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2233);
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hash", 2267);
...
@static
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2295);
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 16)", 2295);
_yuitest_coverline("build/yui-base/yui-base.js", 2296);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2297);
_yuitest_coverline("build/yui-base/yui-base.js", 2299);
...
from = (from > 0 || -1) * Math.floor(Math.abs(from));
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2304);
if (from < 0) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2305);
from += len;

        _yuitest_coverline("build/yui-base/yui-base.js", 2307);
if (from < 0) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2308);
from = 0;
        }
    }
...
return from;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2318);
return -1;
};
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "numericSort", 2340);
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 17)", 2360);
_yuitest_coverline("build/yui-base/yui-base.js", 2361);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2362);
...
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "test", 2390);
...
result = 1;
    } else {_yuitest_coverline("build/yui-base/yui-base.js", 2395);
...
function Queue() {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "Queue", 2424);
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_init", 2436);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "next", 2453);
...
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "last", 2463);
...
return this._q.pop();
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 2474);
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2486);
_yuitest_coverline("build/yui-base/yui-base.js", 2487);
return this._q.length;
    }
};

_yuitest_coverline("build/yui-base/yui-base.js", 2491);
Y.Queue = Queue;
...
_yuitest_coverline("build/yui-base/yui-base.js", 2504);
...
Y.cached = function (source, cache, refetch) {
    /*jshint expr: true*/
    _yuitest_coverfunc("build/yui-base/yui-base.js", "cached", 2533);
_yuitest_coverline("build/yui-base/yui-base.js", 2535);
cache || (cache = {});

    _yuitest_coverline("build/yui-base/yui-base.js", 2537);
return function (arg) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 18)", 2537);
...
@since 3.5.0
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2567);
Y.getLocation = function () {
    // It is safer to look this up every time because yui-base is attached to a
    // YUI instance before a user's config is applied; i.e. `Y.config.win` does
    // not point the correct window object when this file is loaded.
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getLocation", 2567);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "merge", 2592);
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "mix", 2646);
...
to   = mode === 1 || mode === 4 ? receiver.prototype : receiver;
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2673);
if (!from || !to) {
...
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2695);
continue;
            }
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2714);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2722);
for (key in from) {
...
exists = alwaysOverwrite ? false : key in to;
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 2737);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2739);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2740);
if (overwrite || !exists) {
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 19)", 2785);
_yuitest_coverline("build/yui-base/yui-base.js", 2791);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 20)", 2792);
...
return function (obj) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 21)", 2797);
_yuitest_coverline("build/yui-base/yui-base.js", 2798);
F.prototype = obj;
        _yuitest_coverline("build/yui-base/yui-base.js", 2799);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "owns", 2860);
...
O.keys = Lang._isNative(Object.keys) && !hasProtoEnumBug ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "keys", 2898);
...
if (owns(obj, key)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2915);
keys.push(key);
            }
        }
    }
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "values", 2950);
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2971);
_yuitest_coverline("build/yui-base/yui-base.js", 2972);
try {
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hasValue", 2989);
...
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "each", 3013);
...
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "some", 3045);
...
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getValue", 3072);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3102);
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "setValue", 3102);
...
var i,
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3108);
if (leafIdx >= 0) {
...
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isEmpty", 3132);
...
*/
_yuitest_coverline("build/yui-base/yui-base.js", 3168);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui-base/yui-base.js", "parseUA", 3168);
_yuitest_coverline("build/yui-base/yui-base.js", 3170);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "numberify", 3170);
_yuitest_coverline("build/yui-base/yui-base.js", 3171);
var c = 0;
            _yuitest_coverline("build/yui-base/yui-base.js", 3172);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 23)", 3172);
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3416);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3417);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3418);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3419);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3420);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3421);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3422);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3423);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3424);
if ((/rhino/i).test(ua)) {
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "compareVersions", 3623);
