...
_yuitest_coverage["build/base-base/base-base.js"].lines = {"1":0,"19":0,"85":0,"86":0,"87":0,"88":0,"100":0,"117":0,"133":0,"149":0,"170":0,"172":0,"173":0,"176":0,"179":0,"181":0};
_yuitest_coverage["build/base-base/base-base.js"].functions = {"Base:85":0,"(anonymous 1):1":0};
...
var AttributeCore   = Y.AttributeCore,
     ...
     * </dl>
     */
    _yuitest_coverline("build/base-base/base-base.js", 85);
function Base() {
        _yuitest_coverfunc("build/base-base/base-base.js", "Base", 85);
_yuitest_coverline("build/base-base/base-base.js", 86);
BaseCore.apply(this, arguments);
        _yuitest_coverline("build/base-base/base-base.js", 87);
BaseObservable.apply(this, arguments);
        _yuitest_coverline("build/base-base/base-base.js", 88);
AttributeExtras.apply(this, arguments);
     ...
     * @private
     */
    _yuitest_coverline("build/base-base/base-base.js", 100);
Base._ATTR_CFG = BaseCore._ATTR_CFG.concat(BaseObservable._ATTR_CFG);
     ...
     * @private
     */
    _yuitest_coverline("build/base-base/base-base.js", 117);
...
Base.NAME = 'base';
     ...
     * @static
     */
    _yuitest_coverline("build/base-base/base-base.js", 149);
Base.ATTRS = AttributeCore.protectAttrs(BaseCore.ATTRS);
    ...
    @since 3.10.0
    **/
    _yuitest_coverline("build/base-base/base-base.js", 170);
Base.modifyAttrs = BaseCore.modifyAttrs;

    _yuitest_coverline("build/base-base/base-base.js", 172);
Y.mix(Base, BaseCore, false, null, 1);
    _yuitest_coverline("build/base-base/base-base.js", 173);
Y.mix(Base, AttributeExtras, false, null, 1);

    // Needs to be `true`, to overwrite methods from `BaseCore`.
    _yuitest_coverline("build/base-base/base-base.js", 176);
Y.mix(Base, BaseObservable, true, null, 1);

    // Fix constructor
    _yuitest_coverline("build/base-base/base-base.js", 179);
Base.prototype.constructor = Base;

    _yuitest_coverline("build/base-base/base-base.js", 181);
Y.Base = Base;
