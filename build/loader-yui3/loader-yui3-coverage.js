...
return !(Y.UA.ios || Y.UA.android);
    ...
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1239);
...
addFeature('style', 'opacity', {
        test: function() {
            _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "test", 1255);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1256);
return DOCUMENT && 'opacity' in DOCUMENT[DOCUMENT_ELEMENT].style;
        }
    });

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1260);
ret =  (!testFeature('style', 'opacity') &&
            !testFeature('style', 'computedStyle'));

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1263);
return ret;
},
            "trigger": "dom-style"
        },
    ...
    "event-base-ie": {
        ...
        "condition": {
            "name": "event-base-ie",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1385);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1386);
var imp = Y.config.doc && Y.config.doc.implementation;
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1387);
...
return (!svg || useCanvas) && (canvas && canvas.getContext && canvas.getContext("2d"));
    ...
    "graphics-canvas-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1582);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1583);
var DOCUMENT = Y.config.doc,
        useCanvas = Y.config.defaultGraphicEngine && Y.config.defaultGraphicEngine == "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
...
return svg && (useSVG || !canvas);
    ...
    "graphics-svg-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1617);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1618);
var DOCUMENT = Y.config.doc,
        useSVG = !Y.config.defaultGraphicEngine || Y.config.defaultGraphicEngine != "canvas",
		canvas = DOCUMENT && DOCUMENT.createElement("canvas"),
        svg = (DOCUMENT && DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"));
...
return svg && (useSVG || !canvas);
    ...
    "graphics-vml": {
        "condition": {
            "name": "graphics-vml",
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1631);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1632);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
...
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
    ...
    "graphics-vml-default": {
        "condition": {
            ...
            "test": function(Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1645);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 1646);
var DOCUMENT = Y.config.doc,
		canvas = DOCUMENT && DOCUMENT.createElement("canvas");
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1648);
return (DOCUMENT && !DOCUMENT.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") && (!canvas || !canvas.getContext || !canvas.getContext("2d")));
},
            "trigger": "graphics"
        }
...
var docMode = Y.config.doc && Y.config.doc.documentMode;
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1715);
return Y.UA.ie && (!('onhashchange' in Y.config.win) ||
    ...
    "json-parse-shim": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1816);
...
function workingNative( k, v ) {
        _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "workingNative", 1821);
...
return k === "ok" ? true : v;
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1827);
if ( nativeSupport ) {
...
nativeSupport = ( Native.parse( '{"ok":false}', workingNative ) ).ok;
            ...
            _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1832);
nativeSupport = false;
        }
    }
...
return !nativeSupport;
    ...
    "json-stringify-shim": {
        "condition": {
            ...
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 1852);
...
var _JSON = Y.config.global.JSON,
    ...
    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1859);
if ( nativeSupport ) {
        _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1860);
try {
            _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1861);
nativeSupport = ( '0' === Native.stringify(0) );
        } catch ( e ) {
            _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1863);
nativeSupport = false;
        }
    }


    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 1868);
return !nativeSupport;
},
    ...
    "selector-css2": {
        "condition": {
            "name": "selector-css2",
            "test": function (Y) {
    _yuitest_coverfunc("build/loader-yui3/loader-yui3.js", "\"test\"", 2332);
_yuitest_coverline("build/loader-yui3/loader-yui3.js", 2333);
var DOCUMENT = Y.config.doc,
        ret = DOCUMENT && !('querySelectorAll' in DOCUMENT);

    _yuitest_coverline("build/loader-yui3/loader-yui3.js", 2336);
return ret;
},
            "trigger": "selector"
        },
