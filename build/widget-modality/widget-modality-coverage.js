...
_yuitest_coverage["build/widget-modality/widget-modality.js"].lines = {"1":0,"9":0,"29":0,"33":0,"34":0,"35":0,"36":0,"37":0,"38":0,"39":0,"40":0,"41":0,"42":0,"47":0,"57":0,"59":0,"74":0,"111":0,"129":0,"141":0,"143":0,"146":0,"147":0,"150":0,"152":0,"153":0,"162":0,"172":0,"179":0,"182":0,"185":0,"186":0,"187":0,"192":0,"211":0,"219":0,"220":0,"236":0,"237":0,"238":0,"245":0,"249":0,"266":0,"277":0,"280":0,"281":0,"290":0,"301":0,"311":0,"316":0,"318":0,"319":0,"320":0,"324":0,"326":0,"327":0,"329":0,"330":0,"331":0,"332":0,"338":0,"339":0,"341":0,"344":0,"345":0,"347":0,"348":0,"349":0,"351":0,"353":0,"355":0,"356":0,"361":0,"362":0,"378":0,"379":0,"393":0,"396":0,"399":0,"406":0,"408":0,"409":0,"410":0,"411":0,"414":0,"415":0,"419":0,"420":0,"424":0,"425":0,"429":0,"434":0,"435":0,"436":0,"440":0,"449":0,"450":0,"452":0,"463":0,"474":0,"485":0,"487":0,"498":0,"504":0,"506":0,"507":0,"511":0,"514":0,"515":0,"516":0,"517":0,"518":0,"519":0,"532":0,"539":0,"553":0,"555":0,"556":0,"561":0};
_yuitest_coverage["build/widget-modality/widget-modality.js"].functions = {"(anonymous 2):25":0,"WidgetModal:57":0,"valueFn:110":0,"_GET_MASK:141":0,"initializer:184":0,"destructor:190":0,"_renderUIModal:209":0,"_bindUIModal:234":0,"_syncUIModal:262":0,"_focus:275":0,"_blur:288":0,"_getMaskNode:299":0,"(anonymous 3):318":0,"_uiSetHostVisibleModal:310":0,"_uiSetHostZIndexModal:376":0,"(anonymous 4):435":0,"_attachUIHandlesModal:391":0,"(anonymous 5):449":0,"_detachUIHandlesModal:448":0,"_afterHostVisibleChangeModal:461":0,"_afterHostZIndexChangeModal:472":0,"isNested:484":0,"_repositionMask:496":0,"_resyncMask:531":0,"_afterFocusOnChange:552":0,"(anonymous 1):1":0};
_yuitest_coverage["build/widget-modality/widget-modality.js"].coveredLines = 119;
...
this._uiSetHostVisibleModal(this.get(VISIBLE));
        ...
        _focus : function (e) {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_focus", 275);
_yuitest_coverline("build/widget-modality/widget-modality.js", 277);
var bb = this.get(BOUNDING_BOX),
            oldTI = bb.get('tabIndex');

            _yuitest_coverline("build/widget-modality/widget-modality.js", 280);
...
this.focus();
        ...
        _blur : function () {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_blur", 288);
_yuitest_coverline("build/widget-modality/widget-modality.js", 290);
this.blur();
        },
        ...
        _getMaskNode : function () {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_getMaskNode", 299);
_yuitest_coverline("build/widget-modality/widget-modality.js", 301);
return WidgetModal._GET_MASK();
        ...
        _uiSetHostVisibleModal : function (visible) {
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_uiSetHostVisibleModal", 310);
_yuitest_coverline("build/widget-modality/widget-modality.js", 311);
var stack    = WidgetModal.STACK,
                maskNode = this.get('maskNode'),
                isModal  = this.get('modal'),
                topModal, index;

            _yuitest_coverline("build/widget-modality/widget-modality.js", 316);
if (visible) {

                _yuitest_coverline("build/widget-modality/widget-modality.js", 318);
Y.Array.each(stack, function(modal){
                    _yuitest_coverfunc("build/widget-modality/widget-modality.js", "(anonymous 3)", 318);
...
modal._blur();
                ...
                _yuitest_coverline("build/widget-modality/widget-modality.js", 324);
stack.unshift(this);

                _yuitest_coverline("build/widget-modality/widget-modality.js", 326);
this._repositionMask(this);
                _yuitest_coverline("build/widget-modality/widget-modality.js", 327);
this._uiSetHostZIndexModal(this.get(Z_INDEX));

                _yuitest_coverline("build/widget-modality/widget-modality.js", 329);
if (isModal) {
...
this._focus();
                ...
                _yuitest_coverline("build/widget-modality/widget-modality.js", 338);
...
if (index >= 0) {
                    ...
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 341);
stack.splice(index, 1);
                }

                _yuitest_coverline("build/widget-modality/widget-modality.js", 344);
this._detachUIHandlesModal();
                _yuitest_coverline("build/widget-modality/widget-modality.js", 345);
this._blur();

                _yuitest_coverline("build/widget-modality/widget-modality.js", 347);
if (stack.length) {
...
this._repositionMask(topModal);
                    ...
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 351);
topModal._uiSetHostZIndexModal(topModal.get(Z_INDEX));

                    _yuitest_coverline("build/widget-modality/widget-modality.js", 353);
if (topModal.get('modal')) {
                        //topModal._attachUIHandlesModal();
                        _yuitest_coverline("build/widget-modality/widget-modality.js", 355);
...
topModal._focus();
                    ...
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 361);
...
maskNode.hide();
        ...
        _uiSetHostZIndexModal : function (zIndex) {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_uiSetHostZIndexModal", 376);
_yuitest_coverline("build/widget-modality/widget-modality.js", 378);
if (this.get('modal')) {
...
this.get('maskNode').setStyle(Z_INDEX, zIndex || 0);
        ...
        _attachUIHandlesModal : function () {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_attachUIHandlesModal", 391);
_yuitest_coverline("build/widget-modality/widget-modality.js", 393);
if (this._uiHandlesModal || WidgetModal.STACK[0] !== this) {
                // Quit early if we have ui handles, or if we not at the top
                // of the global stack.
                _yuitest_coverline("build/widget-modality/widget-modality.js", 396);
return;
            }

            _yuitest_coverline("build/widget-modality/widget-modality.js", 399);
var bb          = this.get(BOUNDING_BOX),
                maskNode    = this.get('maskNode'),
            ...
            _yuitest_coverline("build/widget-modality/widget-modality.js", 406);
for (i = 0, len = focusOn.length; i < len; i++) {

                _yuitest_coverline("build/widget-modality/widget-modality.js", 408);
o = {};
...
o.keyCode = focusOn[i].keyCode;
                ...
                _yuitest_coverline("build/widget-modality/widget-modality.js", 414);
...
uiHandles.push(bb.on(o.ev, focus));
                ...
                else {_yuitest_coverline("build/widget-modality/widget-modality.js", 419);
if (o.node && !o.keyCode && o.ev) {
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 420);
uiHandles.push(o.node.on(o.ev, focus));
                }

                //node defined, keycode defined, event defined (its a key press)
                else {_yuitest_coverline("build/widget-modality/widget-modality.js", 424);
if (o.node && o.keyCode && o.ev) {
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 425);
uiHandles.push(o.node.on(o.ev, focus, o.keyCode));
                }

                else {
                    _yuitest_coverline("build/widget-modality/widget-modality.js", 429);
Y.Log('focusOn ATTR Error: The event with name "'+o.ev+'" could not be attached.');
                }}}

            }

            _yuitest_coverline("build/widget-modality/widget-modality.js", 434);
if ( ! supportsPosFixed) {
                _yuitest_coverline("build/widget-modality/widget-modality.js", 435);
uiHandles.push(Y.one('win').on('scroll', Y.bind(function(e){
                    _yuitest_coverfunc("build/widget-modality/widget-modality.js", "(anonymous 4)", 435);
_yuitest_coverline("build/widget-modality/widget-modality.js", 436);
maskNode.setStyle('top', maskNode.get('docScrollY'));
                }, this)));
            }

            _yuitest_coverline("build/widget-modality/widget-modality.js", 440);
this._uiHandlesModal = uiHandles;
        ...
        _detachUIHandlesModal : function () {
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_detachUIHandlesModal", 448);
_yuitest_coverline("build/widget-modality/widget-modality.js", 449);
Y.each(this._uiHandlesModal, function(h){
                _yuitest_coverfunc("build/widget-modality/widget-modality.js", "(anonymous 5)", 449);
_yuitest_coverline("build/widget-modality/widget-modality.js", 450);
h.detach();
            });
            _yuitest_coverline("build/widget-modality/widget-modality.js", 452);
this._uiHandlesModal = null;
        ...
        _afterHostVisibleChangeModal : function (e) {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_afterHostVisibleChangeModal", 461);
_yuitest_coverline("build/widget-modality/widget-modality.js", 463);
this._uiSetHostVisibleModal(e.newVal);
        ...
        _afterHostZIndexChangeModal : function (e) {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_afterHostZIndexChangeModal", 472);
_yuitest_coverline("build/widget-modality/widget-modality.js", 474);
this._uiSetHostZIndexModal(e.newVal);
         ...
         */
        isNested: function() {
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "isNested", 484);
_yuitest_coverline("build/widget-modality/widget-modality.js", 485);
var length = WidgetModal.STACK.length,
            retval = (length > 1) ? true : false;
            _yuitest_coverline("build/widget-modality/widget-modality.js", 487);
return retval;
        },
        ...
        _repositionMask: function(nextElem) {
            ...
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_repositionMask", 496);
_yuitest_coverline("build/widget-modality/widget-modality.js", 498);
var currentModal = this.get('modal'),
            ...
            _yuitest_coverline("build/widget-modality/widget-modality.js", 504);
if (currentModal && !nextModal) {
                //leave the mask where it is, since the host is not modal.
                _yuitest_coverline("build/widget-modality/widget-modality.js", 506);
maskNode.remove();
...
this.fire(MaskHide);
            ...
            else {_yuitest_coverline("build/widget-modality/widget-modality.js", 511);
if ((!currentModal && nextModal) || (currentModal && nextModal)) {

                //then remove the mask off DOM, reposition it, and reinsert it into the DOM
                _yuitest_coverline("build/widget-modality/widget-modality.js", 514);
maskNode.remove();
...
this.fire(MaskShow);
        ...
        _resyncMask: function (e) {
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_resyncMask", 531);
_yuitest_coverline("build/widget-modality/widget-modality.js", 532);
var o       = e.currentTarget,
            ...
            _yuitest_coverline("build/widget-modality/widget-modality.js", 539);
mask.setStyles({
                "top": offsetY + "px",
                "left": offsetX + "px",
                "width": w + 'px',
        ...
        _afterFocusOnChange : function(e) {
            _yuitest_coverfunc("build/widget-modality/widget-modality.js", "_afterFocusOnChange", 552);
_yuitest_coverline("build/widget-modality/widget-modality.js", 553);
this._detachUIHandlesModal();

            _yuitest_coverline("build/widget-modality/widget-modality.js", 555);
if (this.get(VISIBLE)) {
...
this._attachUIHandlesModal();
    ...
    _yuitest_coverline("build/widget-modality/widget-modality.js", 561);
