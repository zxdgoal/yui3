...
_yuitest_coverage["build/selector-native/selector-native.js"].lines = {"1":0,"3":0,"18":0,"20":0,"23":0,"44":0,"45":0,"47":0,"52":0,"55":0,"56":0,"57":0,"58":0,"61":0,"65":0,"66":0,"68":0,"72":0,"73":0,"74":0,"75":0,"76":0,"77":0,"78":0,"81":0,"86":0,"87":0,"88":0,"89":0,"93":0,"97":0,"100":0,"101":0,"102":0,"103":0,"107":0,"108":0,"109":0,"112":0,"126":0,"127":0,"135":0,"137":0,"139":0,"142":0,"143":0,"144":0,"145":0,"147":0,"148":0,"152":0,"153":0,"157":0,"162":0,"167":0,"170":0,"171":0,"173":0,"174":0,"176":0,"185":0,"186":0,"187":0,"188":0,"189":0,"193":0,"196":0,"197":0,"198":0,"199":0,"201":0,"207":0,"208":0,"211":0,"218":0,"220":0,"221":0,"223":0,"224":0,"225":0,"228":0,"231":0,"232":0,"233":0,"237":0,"241":0,"246":0,"248":0,"249":0,"251":0,"256":0,"259":0,"260":0,"261":0,"262":0,"268":0,"272":0,"282":0,"284":0,"285":0,"288":0,"289":0,"290":0,"291":0,"292":0,"294":0,"295":0,"296":0,"297":0,"300":0,"302":0,"303":0,"304":0,"305":0,"308":0,"309":0,"310":0,"312":0,"313":0,"314":0,"315":0,"318":0,"319":0,"323":0,"324":0,"326":0,"329":0,"342":0,"343":0,"348":0,"352":0,"353":0,"357":0,"358":0,"360":0,"361":0,"364":0,"368":0};
_yuitest_coverage["build/selector-native/selector-native.js"].functions = {"_escapeId:43":0,"(anonymous 3):51":0,"(anonymous 4):64":0,"}:71":0,"_sort:85":0,"_deDupe:96":0,"query:125":0,"_replaceSelector:161":0,"_restoreSelector:184":0,"_replaceCommas:192":0,"_splitQueries:206":0,"_nativeQuery:240":0,"filter:255":0,"test:271":0,"(anonymous 5):342":0,"ancestor:341":0,"_parse:347":0,"_replace:351":0,"_restore:356":0,"(anonymous 2):3":0,"(anonymous 1):1":0};
...
try {
            _yuitest_coverline("build/selector-native/selector-native.js", 249);
return root['querySelector' + (one ? '' : 'All')](selector);
        } catch(e) { // fallback to brute if available
            _yuitest_coverline("build/selector-native/selector-native.js", 251);
return Y.Selector.query(selector, root, one, true); // redo with skipNative true
        }
    },

    filter: function(nodes, selector) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "filter", 255);
...
if (nodes && selector) {
            _yuitest_coverline("build/selector-native/selector-native.js", 260);
for (i = 0; (node = nodes[i++]);) {
                _yuitest_coverline("build/selector-native/selector-native.js", 261);
if (Y.Selector.test(node, selector)) {
                    _yuitest_coverline("build/selector-native/selector-native.js", 262);
ret[ret.length] = node;
                }
            }
        } else {
        ...
        _yuitest_coverline("build/selector-native/selector-native.js", 268);
return ret;
    },

    test: function(node, selector, root) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "test", 271);
_yuitest_coverline("build/selector-native/selector-native.js", 272);
var ret = false,
            useFrag = false,
            groups,
            parent,
...
if (node && node.tagName) { // only test HTMLElements
            ...
            _yuitest_coverline("build/selector-native/selector-native.js", 284);
...
if (!root && !Y.DOM.inDoc(node)) {
                    _yuitest_coverline("build/selector-native/selector-native.js", 290);
...
frag = node[OWNER_DOCUMENT].createDocumentFragment();
                        _yuitest_coverline("build/selector-native/selector-native.js", 295);
frag.appendChild(node);
                        _yuitest_coverline("build/selector-native/selector-native.js", 296);
root = frag;
...
id = Y.Selector._escapeId(Y.DOM.getId(node));
                _yuitest_coverline("build/selector-native/selector-native.js", 303);
if (!id) {
                    _yuitest_coverline("build/selector-native/selector-native.js", 304);
id = Y.guid();
                    _yuitest_coverline("build/selector-native/selector-native.js", 305);
Y.DOM.setId(node, id);
                }

                _yuitest_coverline("build/selector-native/selector-native.js", 308);
...
for (j = 0; item = items[j++];) {
                        _yuitest_coverline("build/selector-native/selector-native.js", 313);
if (item === node) {
                            _yuitest_coverline("build/selector-native/selector-native.js", 314);
ret = true;
                            _yuitest_coverline("build/selector-native/selector-native.js", 315);
break;
                        }
                    }
                    _yuitest_coverline("build/selector-native/selector-native.js", 318);
if (ret) {
                        _yuitest_coverline("build/selector-native/selector-native.js", 319);
break;
                    }
                }
...
if (useFrag) { // cleanup
                    _yuitest_coverline("build/selector-native/selector-native.js", 324);
...
;
        ...
        _yuitest_coverline("build/selector-native/selector-native.js", 329);
return ret;
    },
    ...
    ancestor: function (element, selector, testSelf) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "ancestor", 341);
_yuitest_coverline("build/selector-native/selector-native.js", 342);
return Y.DOM.ancestor(element, function(n) {
            _yuitest_coverfunc("build/selector-native/selector-native.js", "(anonymous 5)", 342);
_yuitest_coverline("build/selector-native/selector-native.js", 343);
return Y.Selector.test(n, selector);
        }, testSelf);
    },

    _parse: function(name, selector) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "_parse", 347);
_yuitest_coverline("build/selector-native/selector-native.js", 348);
return selector.match(Y.Selector._types[name].re);
    },

    _replace: function(name, selector) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "_replace", 351);
_yuitest_coverline("build/selector-native/selector-native.js", 352);
var o = Y.Selector._types[name];
        _yuitest_coverline("build/selector-native/selector-native.js", 353);
return selector.replace(o.re, o.token);
    },

    _restore: function(name, selector, items) {
        _yuitest_coverfunc("build/selector-native/selector-native.js", "_restore", 356);
...
var token = Y.Selector._types[name].token,
                i, len;
            _yuitest_coverline("build/selector-native/selector-native.js", 360);
for (i = 0, len = items.length; i < len; ++i) {
                _yuitest_coverline("build/selector-native/selector-native.js", 361);
selector = selector.replace(token, items[i]);
            }
        }
        _yuitest_coverline("build/selector-native/selector-native.js", 364);
return selector;
    }
};

_yuitest_coverline("build/selector-native/selector-native.js", 368);
