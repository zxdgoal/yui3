...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Object owns " + count + " properties but should own none."));        
    ...
    ownsOrInheritsKey: function (propertyName, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsOrInheritsKey", 3313);
...
YUITest.Assert.fail(YUITest.Assert._formatMessage(message, "Property '" + propertyName + "' not found on object."));
    ...
    ownsOrInheritsKeys: function (properties, object, message) {
        _yuitest_coverfunc("build/test/test.js", "ownsOrInheritsKeys", 3328);
 ...
 */
_yuitest_coverline("build/test/test.js", 3347);
YUITest.Results = function(name){
     ...
     * @property name
     */
    _yuitest_coverfunc("build/test/test.js", "Results", 3347);
_yuitest_coverline("build/test/test.js", 3354);
this.name = name;
     ...
     * @property passed
     */
    _yuitest_coverline("build/test/test.js", 3361);
this.passed = 0;
     ...
     * @property failed
     */
    _yuitest_coverline("build/test/test.js", 3368);
this.failed = 0;
     ...
     * @property errors
     */
    _yuitest_coverline("build/test/test.js", 3375);
this.errors = 0;
     ...
     * @property ignored
     */
    _yuitest_coverline("build/test/test.js", 3382);
this.ignored = 0;
     ...
     * @property total
     */
    _yuitest_coverline("build/test/test.js", 3389);
this.total = 0;
     ...
     * @property duration
     */
    _yuitest_coverline("build/test/test.js", 3396);
this.duration = 0;
};
...
YUITest.Results.prototype.include = function(results){
    _yuitest_coverfunc("build/test/test.js", "include", 3405);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3423);
YUITest.ShouldError = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldError", 3423);
_yuitest_coverline("build/test/test.js", 3426);
...
//restore constructor
_yuitest_coverline("build/test/test.js", 3441);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3453);
YUITest.ShouldFail = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldFail", 3453);
_yuitest_coverline("build/test/test.js", 3456);
...
//restore constructor
_yuitest_coverline("build/test/test.js", 3471);
 ...
 * @constructor
 */  
_yuitest_coverline("build/test/test.js", 3485);
YUITest.UnexpectedError = function (cause){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedError", 3485);
_yuitest_coverline("build/test/test.js", 3488);
YUITest.AssertionError.call(this, "Unexpected error: " + cause.message);
     ...
     * @property cause
     */
    _yuitest_coverline("build/test/test.js", 3495);
this.cause = cause;
     ...
     * @property name
     */
    _yuitest_coverline("build/test/test.js", 3502);
...
//restore constructor
_yuitest_coverline("build/test/test.js", 3517);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3532);
YUITest.UnexpectedValue = function (message, unexpected){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedValue", 3532);
_yuitest_coverline("build/test/test.js", 3535);
YUITest.AssertionError.call(this, message);
     ...
     * @property unexpected
     */
    _yuitest_coverline("build/test/test.js", 3542);
...
//restore constructor
_yuitest_coverline("build/test/test.js", 3557);
...
YUITest.UnexpectedValue.prototype.getMessage = function(){
    _yuitest_coverfunc("build/test/test.js", "getMessage", 3565);
_yuitest_coverline("build/test/test.js", 3566);
 ...
 *
 */
_yuitest_coverline("build/test/test.js", 3580);
YUITest.Wait = function (segment, delay) {
     ...
     * @property segment
     */
    _yuitest_coverfunc("build/test/test.js", "Wait", 3580);
_yuitest_coverline("build/test/test.js", 3587);
...
Y.Object.each(YUITest, function(item, name) {
    _yuitest_coverfunc("build/test/test.js", "(anonymous 14)", 3600);
...
Y.Test.ArrayAssert.itemsAreEqual = function(expected, actual, message) {
    _yuitest_coverfunc("build/test/test.js", "itemsAreEqual", 3619);
...
Y.assert = function(condition, message){
    _yuitest_coverfunc("build/test/test.js", "assert", 3633);
...
Y.Test.Runner.disableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "disableLogging", 3651);
...
Y.Test.Runner.enableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "enableLogging", 3655);
...
YUI.YUITest = Y.Test;
    ...
    _yuitest_coverline("build/test/test.js", 3675);
var logEvent = function(event) {
        
        //data variables
        _yuitest_coverfunc("build/test/test.js", "logEvent", 3675);
...
message = "Unexpected event " + event.type;
                _yuitest_coverline("build/test/test.js", 3740);
messageType = "info";
        }
