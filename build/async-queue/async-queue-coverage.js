...
_yuitest_coverage["build/async-queue/async-queue.js"].lines = {"1":0,"41":0,"42":0,"43":0,"46":0,"70":0,"75":0,"76":0,"80":0,"99":0,"101":0,"110":0,"112":0,"122":0,"142":0,"144":0,"145":0,"146":0,"147":0,"148":0,"150":0,"154":0,"167":0,"168":0,"186":0,"187":0,"190":0,"197":0,"198":0,"200":0,"201":0,"206":0,"219":0,"222":0,"223":0,"224":0,"227":0,"231":0,"239":0,"240":0,"244":0,"249":0,"252":0,"266":0,"267":0,"269":0,"270":0,"272":0,"274":0,"275":0,"277":0,"289":0,"290":0,"291":0,"295":0,"306":0,"318":0,"331":0,"333":0,"347":0,"350":0,"351":0,"352":0,"353":0,"357":0,"371":0,"372":0,"375":0,"377":0,"390":0,"392":0,"393":0,"394":0,"401":0,"413":0,"415":0,"416":0,"417":0,"418":0,"422":0,"434":0,"436":0,"450":0,"452":0,"453":0,"454":0,"455":0,"458":0,"461":0,"476":0,"479":0,"481":0,"482":0,"496":0,"500":0,"501":0,"502":0,"503":0,"506":0,"509":0,"524":0,"526":0,"538":0,"539":0,"542":0};
_yuitest_coverage["build/async-queue/async-queue.js"].functions = {"AsyncQueue:41":0,"until:74":0,"_init:98":0,"_initEvents:121":0,"next:141":0,"_defShiftFn:166":0,"(anonymous 2):196":0,"_prepare:185":0,"run:218":0,"_execute:264":0,"(anonymous 3):289":0,"_schedule:288":0,"isRunning:305":0,"_defExecFn:317":0,"add:330":0,"(anonymous 4):350":0,"_defAddFn:346":0,"pause:370":0,"stop:388":0,"indexOf:412":0,"getCallback:433":0,"(anonymous 5):453":0,"promote:449":0,"_defPromoteFn:475":0,"(anonymous 6):501":0,"remove:495":0,"_defRemoveFn:523":0,"size:535":0,"(anonymous 1):1":0};
_yuitest_coverage["build/async-queue/async-queue.js"].coveredLines = 105;
...
if (this._executing) {
            _yuitest_coverline("build/async-queue/async-queue.js", 223);
this._running = true;
            _yuitest_coverline("build/async-queue/async-queue.js", 224);
return this;
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 227);
...
if (!cont) {
                _yuitest_coverline("build/async-queue/async-queue.js", 240);
break;
            }
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 244);
if (!callback) {
            /**
             * Event fired after the last queued callback is executed.
             * @event complete
             */
            _yuitest_coverline("build/async-queue/async-queue.js", 249);
this.fire('complete');
        }
...
return this;
    ...
    _execute : function (callback) {
        ...
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_execute", 264);
_yuitest_coverline("build/async-queue/async-queue.js", 266);
this._running   = callback._running = true;
        _yuitest_coverline("build/async-queue/async-queue.js", 267);
this._executing = callback;

        _yuitest_coverline("build/async-queue/async-queue.js", 269);
callback.iterations--;
        _yuitest_coverline("build/async-queue/async-queue.js", 270);
this.fire(EXECUTE, { callback: callback });

        _yuitest_coverline("build/async-queue/async-queue.js", 272);
...
this._executing = false;
        ...
        _yuitest_coverline("build/async-queue/async-queue.js", 277);
return cont;
    },
    ...
    _schedule : function (callback) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_schedule", 288);
_yuitest_coverline("build/async-queue/async-queue.js", 289);
this._running = Y.later(callback.timeout, this, function () {
            _yuitest_coverfunc("build/async-queue/async-queue.js", "(anonymous 3)", 289);
_yuitest_coverline("build/async-queue/async-queue.js", 290);
if (this._execute(callback)) {
                _yuitest_coverline("build/async-queue/async-queue.js", 291);
this.run();
            }
        });

        _yuitest_coverline("build/async-queue/async-queue.js", 295);
return false;
    },
     ...
     */
    isRunning : function () {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "isRunning", 305);
_yuitest_coverline("build/async-queue/async-queue.js", 306);
return !!this._running;
    ...
    _defExecFn : function (e) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_defExecFn", 317);
_yuitest_coverline("build/async-queue/async-queue.js", 318);
e.callback();
    },
     ...
     */
    add : function () {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "add", 330);
_yuitest_coverline("build/async-queue/async-queue.js", 331);
this.fire('add', { callbacks: Y.Array(arguments,0,true) });

        _yuitest_coverline("build/async-queue/async-queue.js", 333);
return this;
    },
    ...
    _defAddFn : function(e) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_defAddFn", 346);
_yuitest_coverline("build/async-queue/async-queue.js", 347);
var _q = this._q,
            added = [];

        _yuitest_coverline("build/async-queue/async-queue.js", 350);
Y.Array.each(e.callbacks, function (c) {
            _yuitest_coverfunc("build/async-queue/async-queue.js", "(anonymous 4)", 350);
_yuitest_coverline("build/async-queue/async-queue.js", 351);
if (isObject(c)) {
                _yuitest_coverline("build/async-queue/async-queue.js", 352);
_q.push(c);
                _yuitest_coverline("build/async-queue/async-queue.js", 353);
added.push(c);
            }
        });

        _yuitest_coverline("build/async-queue/async-queue.js", 357);
e.added = added;
    },
     ...
     */
    pause: function () {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "pause", 370);
_yuitest_coverline("build/async-queue/async-queue.js", 371);
if (this._running && isObject(this._running)) {
            _yuitest_coverline("build/async-queue/async-queue.js", 372);
...
this._running = false;
        ...
        _yuitest_coverline("build/async-queue/async-queue.js", 377);
return this;
    },
    ...
    stop : function () {
        ...
        _yuitest_coverfunc("build/async-queue/async-queue.js", "stop", 388);
_yuitest_coverline("build/async-queue/async-queue.js", 390);
this._q = [];

        _yuitest_coverline("build/async-queue/async-queue.js", 392);
if (this._running && isObject(this._running)) {
            _yuitest_coverline("build/async-queue/async-queue.js", 393);
this._running.cancel();
            _yuitest_coverline("build/async-queue/async-queue.js", 394);
this._running = false;
        }
        ...
        _yuitest_coverline("build/async-queue/async-queue.js", 401);
return this;
    },
    ...
    indexOf : function (callback) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "indexOf", 412);
_yuitest_coverline("build/async-queue/async-queue.js", 413);
var i = 0, len = this._q.length, c;

        _yuitest_coverline("build/async-queue/async-queue.js", 415);
for (; i < len; ++i) {
            _yuitest_coverline("build/async-queue/async-queue.js", 416);
c = this._q[i];
            _yuitest_coverline("build/async-queue/async-queue.js", 417);
if (c === callback || c.id === callback) {
                _yuitest_coverline("build/async-queue/async-queue.js", 418);
return i;
            }
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 422);
return -1;
    },
    ...
    getCallback : function (id) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "getCallback", 433);
_yuitest_coverline("build/async-queue/async-queue.js", 434);
var i = this.indexOf(id);

        _yuitest_coverline("build/async-queue/async-queue.js", 436);
return (i > -1) ? this._q[i] : null;
    ...
    promote : function (callback) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "promote", 449);
_yuitest_coverline("build/async-queue/async-queue.js", 450);
var payload = { callback : callback },e;

        _yuitest_coverline("build/async-queue/async-queue.js", 452);
if (this.isRunning()) {
            _yuitest_coverline("build/async-queue/async-queue.js", 453);
e = this.after(SHIFT, function () {
                    _yuitest_coverfunc("build/async-queue/async-queue.js", "(anonymous 5)", 453);
_yuitest_coverline("build/async-queue/async-queue.js", 454);
this.fire(PROMOTE, payload);
                    _yuitest_coverline("build/async-queue/async-queue.js", 455);
e.detach();
                }, this);
        } else {
            _yuitest_coverline("build/async-queue/async-queue.js", 458);
this.fire(PROMOTE, payload);
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 461);
return this;
    },
    ...
    _defPromoteFn : function (e) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_defPromoteFn", 475);
_yuitest_coverline("build/async-queue/async-queue.js", 476);
var i = this.indexOf(e.callback),
            promoted = (i > -1) ? this._q.splice(i,1)[0] : null;

        _yuitest_coverline("build/async-queue/async-queue.js", 479);
e.promoted = promoted;

        _yuitest_coverline("build/async-queue/async-queue.js", 481);
if (promoted) {
            _yuitest_coverline("build/async-queue/async-queue.js", 482);
this._q.unshift(promoted);
    ...
    remove : function (callback) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "remove", 495);
_yuitest_coverline("build/async-queue/async-queue.js", 496);
var payload = { callback : callback },e;
...
if (this.isRunning()) {
            _yuitest_coverline("build/async-queue/async-queue.js", 501);
e = this.after(SHIFT, function () {
                    _yuitest_coverfunc("build/async-queue/async-queue.js", "(anonymous 6)", 501);
_yuitest_coverline("build/async-queue/async-queue.js", 502);
this.fire(REMOVE, payload);
                    _yuitest_coverline("build/async-queue/async-queue.js", 503);
e.detach();
                },this);
        } else {
            _yuitest_coverline("build/async-queue/async-queue.js", 506);
this.fire(REMOVE, payload);
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 509);
return this;
    },
    ...
    _defRemoveFn : function (e) {
        _yuitest_coverfunc("build/async-queue/async-queue.js", "_defRemoveFn", 523);
_yuitest_coverline("build/async-queue/async-queue.js", 524);
var i = this.indexOf(e.callback);

        _yuitest_coverline("build/async-queue/async-queue.js", 526);
e.removed = (i > -1) ? this._q.splice(i,1)[0] : null;
    ...
    size : function () {
        ...
        _yuitest_coverfunc("build/async-queue/async-queue.js", "size", 535);
_yuitest_coverline("build/async-queue/async-queue.js", 538);
if (!this.isRunning()) {
            _yuitest_coverline("build/async-queue/async-queue.js", 539);
this.next();
        }

        _yuitest_coverline("build/async-queue/async-queue.js", 542);
