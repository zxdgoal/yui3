...
transaction.c.abort();
    ...
    */
    send: function(uri, config, id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "send", 638);
...
method = config.method ? config.method.toUpperCase() : 'GET';
        _yuitest_coverline("build/io-base/io-base.js", 647);
sync = config.sync;
        _yuitest_coverline("build/io-base/io-base.js", 648);
data = config.data;
...
config.data = data = Y.QueryString.stringify(data);
        ...
        _yuitest_coverline("build/io-base/io-base.js", 659);
if (config.form) {
            _yuitest_coverline("build/io-base/io-base.js", 660);
if (config.form.upload) {
                // This is a file upload transaction, calling
                // upload() in io-upload-iframe.
                _yuitest_coverline("build/io-base/io-base.js", 663);
...
return io.xdr(u, transaction, config);
        ...
        else {_yuitest_coverline("build/io-base/io-base.js", 698);
if (transaction.notify) {
...
transaction.c.onreadystatechange = function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "onreadystatechange", 704);
...
response.getAllResponseHeaders = function() {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getAllResponseHeaders", 734);
...
response.getResponseHeader = function(name) {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getResponseHeader", 738);
...
return {
            id: transaction.id,
            abort: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "abort", 770);
_yuitest_coverline("build/io-base/io-base.js", 771);
return transaction.c ? io._abort(transaction, 'abort') : false;
            },
            isInProgress: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "isInProgress", 773);
_yuitest_coverline("build/io-base/io-base.js", 774);
...
@for YUI
**/
_yuitest_coverline("build/io-base/io-base.js", 886);
Y.io = function(url, config) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "io", 886);
_yuitest_coverline("build/io-base/io-base.js", 889);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("build/io-base/io-base.js", 890);
...
Y.io.header = function(name, value) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "header", 904);
...
_yuitest_coverline("build/io-base/io-base.js", 913);
Y.io._map = {};
...
Y.mix(Y.IO, {
    ...
    */
    defaultTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "defaultTransport", 938);
_yuitest_coverline("build/io-base/io-base.js", 939);
if (id) {
            _yuitest_coverline("build/io-base/io-base.js", 940);
Y.IO._default = id;
        } else {
            _yuitest_coverline("build/io-base/io-base.js", 942);
var o = {
...
return o;
    ...
    */
    transports: {
        xhr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xhr", 956);
_yuitest_coverline("build/io-base/io-base.js", 957);
return XHR ? new XMLHttpRequest() :
                AX ? new ActiveXObject('Microsoft.XMLHTTP') : null;
        },
        xdr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xdr", 960);
_yuitest_coverline("build/io-base/io-base.js", 961);
return XDR ? new XDomainRequest() : null;
        },
        iframe: function () { _yuitest_coverfunc("build/io-base/io-base.js", "iframe", 963);
...
return {}; },
    ...
    */
    customTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "customTransport", 973);
_yuitest_coverline("build/io-base/io-base.js", 974);
var o = { c: Y.IO.transports[id]() };

        _yuitest_coverline("build/io-base/io-base.js", 976);
...
Y.mix(Y.IO.prototype, {
    ...
    */
    notify: function(event, transaction, config) {
        _yuitest_coverfunc("build/io-base/io-base.js", "notify", 990);
_yuitest_coverline("build/io-base/io-base.js", 991);
var io = this;

        _yuitest_coverline("build/io-base/io-base.js", 993);
switch (event) {
            case 'timeout':
            case 'abort':
            case 'transport error':
                _yuitest_coverline("build/io-base/io-base.js", 997);
transaction.c = { status: 0, statusText: event };
                _yuitest_coverline("build/io-base/io-base.js", 998);
event = 'failure';
            default:
                _yuitest_coverline("build/io-base/io-base.js", 1000);
